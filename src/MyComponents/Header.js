...
export default function Navbar({ fixed }) {
  ...
  const handleProfile = () => {
    ...
    <>
      ...
      <Disclosure as="nav" className="bg-black dark:bg-gray-900">
        {({ open }) => (
          <>
              ...
              <div className="relative flex items-center justify-between h-16">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  <button
                    ...
                    className="p-2 text-gray-400 rounded-full hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                  >
                  ...
                  {currentUser ? (
                    <Menu as="div" className="relative ml-3">
                      ...
                      >
                        <Menu.Items className="absolute right-0 z-10 w-48 py-1 mt-2 origin-top-right bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              <button
                                ...
                                onMouseOver={() => speak({ text: "Sign out" })}
